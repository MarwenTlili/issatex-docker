...
const navigations: NavigationLink[] = [
    { name: 'Home', href: '/', isCurrent: true, roles: ['ROLE_CLIENT', 'ROLE_SECRETARY'] },
    { name: 'Articles', href: '/articles', isCurrent: false, roles: ['ROLE_CLIENT'] },
    ...
    { name: 'Attendances', href: '/islet-employee-attendances', isCurrent: false, roles: ['ROLE_SECRETARY'] },
];
                                ...
                                <div className="hidden sm:ml-6 sm:block">
                                    <div className="flex space-x-4">
                                        {navigations.map((item) => {
                                            if (hasCommonElement(roles, item.roles)) {
                                                return (
                                                    <ActiveLink
                                                        key={item.name}
                                                        href={item.href}
...
// check if at least one element from array1 exists in array2
