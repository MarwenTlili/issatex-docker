 ...
 */
final class Version20230306084107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id UUID NOT NULL, designation VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, composition TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE employee (id UUID NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, registration_code VARCHAR(255) NOT NULL, category VARCHAR(255) DEFAULT NULL, recuruitment_at DATE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN employee.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN employee.recuruitment_at IS \'(DC2Type:date_immutable)\'');
        ...
        $this->addSql('CREATE TABLE ilot (id UUID NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN ilot.id IS \'(DC2Type:ulid)\'');
        $this->addSql('CREATE TABLE ilot_employee (id UUID NOT NULL, ilot_id UUID NOT NULL, employee_id UUID NOT NULL, start_at DATE NOT NULL, end_at DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_292D4CE9A4BD21C ON ilot_employee (ilot_id)');
        $this->addSql('CREATE INDEX IDX_292D4CE8C03F15C ON ilot_employee (employee_id)');
        $this->addSql('COMMENT ON COLUMN ilot_employee.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN ilot_employee.ilot_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN ilot_employee.employee_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN ilot_employee.start_at IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN ilot_employee.end_at IS \'(DC2Type:date_immutable)\'');
        $this->addSql('CREATE TABLE ilot_machine (id UUID NOT NULL, ilot_id UUID NOT NULL, start_at DATE NOT NULL, end_at DATE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_1D2CB8BD9A4BD21C ON ilot_machine (ilot_id)');
        $this->addSql('COMMENT ON COLUMN ilot_machine.id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN ilot_machine.ilot_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN ilot_machine.start_at IS \'(DC2Type:date_immutable)\'');
        $this->addSql('COMMENT ON COLUMN ilot_machine.end_at IS \'(DC2Type:date_immutable)\'');
        ...
        $this->addSql('CREATE TABLE machine (id UUID NOT NULL, name VARCHAR(255) NOT NULL, category VARCHAR(255) NOT NULL, brand VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN machine.id IS \'(DC2Type:ulid)\'');
        $this->addSql('CREATE TABLE manufacturing_order (id UUID NOT NULL, client_id UUID NOT NULL, article_id UUID NOT NULL, invoice_id UUID DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, total_quantity INT NOT NULL, technical_document VARCHAR(255) DEFAULT NULL, unit_time INT NOT NULL, unit_price NUMERIC(10, 3) NOT NULL, total_price NUMERIC(10, 3) DEFAULT NULL, observation TEXT DEFAULT NULL, urgent BOOLEAN NOT NULL, launched BOOLEAN NOT NULL, denied BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id UUID NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, avatar VARCHAR(180) DEFAULT NULL, password VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, last_login_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_verified BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE INDEX IDX_CA8F7CC660741FF8 ON weekly_schedule (manufacturing_order_id)');
        ...
        $this->addSql('ALTER TABLE ilot_employee ADD CONSTRAINT FK_292D4CE9A4BD21C FOREIGN KEY (ilot_id) REFERENCES ilot (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ilot_employee ADD CONSTRAINT FK_292D4CE8C03F15C FOREIGN KEY (employee_id) REFERENCES employee (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE ilot_machine ADD CONSTRAINT FK_1D2CB8BD9A4BD21C FOREIGN KEY (ilot_id) REFERENCES ilot (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ilot_employee DROP CONSTRAINT FK_292D4CE9A4BD21C');
        $this->addSql('ALTER TABLE ilot_employee DROP CONSTRAINT FK_292D4CE8C03F15C');
        $this->addSql('ALTER TABLE ilot_machine DROP CONSTRAINT FK_1D2CB8BD9A4BD21C');
        ...
        $this->addSql('DROP TABLE ilot_employee');
